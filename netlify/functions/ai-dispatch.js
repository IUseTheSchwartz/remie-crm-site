...
exports.handler = async (event) => {
  ...
  if (priceHint) {
    ...
    const outText = es
      ? `Perfecto—las cifras dependen de edad y salud. Es una llamada breve de 5–7 min.${bookingLink ? ` Puede elegir horario aquí: ${bookingLink}` : ""} ¿Qué hora le queda mejor?`
      : `Totally—exact numbers depend on age and health. It’s a quick 5–7 min call.${bookingLink ? ` You can grab a time here: ${bookingLink}` : ""} What time works for you?`;
