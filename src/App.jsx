...
// Keep the original premium look
const BRAND = {
  name: "Remie CRM",
...
// Pricing plans (unchanged content, original style)
const PLANS = [
  {
    name: "Mail List",
...
// ---------- Landing Page (original premium look) ----------
...
// ---------- Dashboard (kept original look, added links) ----------
function AppLayout() {
    ...
    <div className="min-h-screen bg-neutral-950 text-white grid md:grid-cols-[240px_1fr]">
      ...
      <aside className="hidden md:block border-r border-white/10 bg-black/30">
        ...
        <nav className="p-3 space-y-1 text-sm">
          ...
          <DashLink to="/app/leads">Leads</DashLink>{/* NEW */}
