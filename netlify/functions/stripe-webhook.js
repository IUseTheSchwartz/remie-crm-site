...
exports.handler = async (event) => {
  ...
  try {
    ...
    // 🔑 This is what used to map your user id reliably
    ...
    if (!userId) {
      ...
      // still record a row without user_id? Usually not helpful for your gate.
      // Return 200 so Stripe doesn't retry forever.
      return { statusCode: 200, body: "no user mapped" };
    }

    // ✅ UPSERT (so replays/updates don’t duplicate)
