...
// Calls your existing messages-send for the real run.
// Env guard + batch cap + throttling + strict, non-invasive design.
...
// Optional absolute override; otherwise we use Netlify's function path
const ABS_SEND_URL =
...
// ---- Inlined phone helpers (Option A) ----
...
exports.handler = async (event) => {
  ...
  try {
    ...
    if (dryRun) {
      ...
      else if (wallet_balance_cents < estimated_cost_cents) blocker = "insufficient_balance";
